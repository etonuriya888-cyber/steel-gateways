      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-4">
            <a href="tel:+77715992660" className="group flex items-center gap-4 rounded-2xl border border-border bg-surface p-6 transition hover:border-gold/40">
              ...
              <div>
                <div className="text-xs uppercase tracking-widest text-muted-foreground">Телефон 1</div>
            ...
            <a href="https://wa.me/77025722129" target="_blank" rel="noreferrer" className="group flex items-center gap-4 rounded-2xl border border-border bg-surface p-6 transition hover:border-gold/40">
              ...
              <div>
                ...
                <div className="font-display text-xl font-bold group-hover:text-gold">Написать в WhatsApp</div>
              </div>
            </a>
            <a href="mailto:nurhat_84@mail.ru" className="group flex items-center gap-4 rounded-2xl border border-border bg-surface p-6 transition hover:border-gold/40">
              <div className="grid h-12 w-12 place-items-center rounded-xl bg-gradient-gold text-gold-foreground"><Mail className="h-5 w-5" /></div>
              <div>
          ...
          <div className="glass rounded-3xl p-6 md:p-10">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Заполните форму — инженер свяжется с вами.</p>
            <div className="mt-6">
              <RequestForm compact />
            </div>
          </div>
