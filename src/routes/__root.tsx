...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TEMIR QAZYNA XXI — Производитель трубопроводной арматуры в Казахстане" },
      { property: "og:description", content: "Казахстанский производитель стальных клиновых задвижек и трубопроводной арматуры для нефтегазовой отрасли, энергетики и водоснабжения. Сертификат CT-KZ." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "TEMIR QAZYNA XXI" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TEMIR QAZYNA XXI — Производитель трубопроводной арматуры в Казахстане" },
      { name: "twitter:description", content: "Казахстанский производитель стальных клиновых задвижек и трубопроводной арматуры для нефтегазовой отрасли, энергетики и водоснабжения. Сертификат CT-KZ." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f9ffd469-b488-44bd-811f-6eaab1f2f1f1/id-preview-601b732f--d51da686-4c5e-44be-9022-030fb9f26f09.lovable.app-1780356063263.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f9ffd469-b488-44bd-811f-6eaab1f2f1f1/id-preview-601b732f--d51da686-4c5e-44be-9022-030fb9f26f09.lovable.app-1780356063263.png" },
    ],
    links: [
